                    ...
                    <form action="{{ route('admin.country.healthy-living.store', $country_code) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="body" name="body" rows="10" class="block mt-1 w-full rounded-md shadow-sm txt-lg border-gray-300 dark:bg-gray-900 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-500 font-mono">{{ old('body') }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="text" name="article_url" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 bg-gray-50 dark:bg-gray-900 dark:border-gray-700">
